// Objective-C API for talking to github.com/ftauth/sdk-mobile Go package.
//   gobind -lang=objc github.com/ftauth/sdk-mobile
//
 ...
 */
@interface FtauthinternalClient : NSObject <goSeqRefInterface, FtauthinternalAuthorizationCodeCompleter> {
}
@property(strong, readonly) _Nonnull id _ref;
 ...
 */
- (void)login:(id<FtauthinternalWebViewLauncher> _Nullable)webView completion:(id<FtauthinternalLoginCompleter> _Nullable)completion;
- (void)rLock;
...
an FTAuth client.
 */
FOUNDATION_EXPORT FtauthinternalConfig* _Nullable FtauthinternalNewClientOptions(long timeout, BOOL useDPoP, id<FtauthinternalKeyStore> _Nullable keyStore, id<FtauthinternalLogger> _Nullable logger, NSData* _Nullable clientConfigJSON, NSError* _Nullable* _Nullable error);
